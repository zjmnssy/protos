...
var file_ezdev_agent_pc_agent_server_proto_rawDesc = []byte{
	...
	0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x96,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x21, 0x5a, 0x1f, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x7a, 0x6a, 0x6d, 0x6e, 0x73, 0x73, 0x79, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
type PcAgentClient interface {
	...
	GetStatus(ctx context.Context, in *GetStatusRequest, opts ...grpc.CallOption) (PcAgent_GetStatusClient, error)
}
...
func (c *pcAgentClient) GetStatus(ctx context.Context, in *GetStatusRequest, opts ...grpc.CallOption) (PcAgent_GetStatusClient, error) {
...
type PcAgentServer interface {
	...
	GetStatus(*GetStatusRequest, PcAgent_GetStatusServer) error
}
...
func (*UnimplementedPcAgentServer) GetStatus(*GetStatusRequest, PcAgent_GetStatusServer) error {
...
func _PcAgent_GetStatus_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PcAgentServer).GetStatus(m, &pcAgentGetStatusServer{stream})
}
